...
struct VKVideoAttachment: Decodable {
    ...
    // Manual override from rawCall parsing (not from JSON decode)
    var _directUrl: String? = nil
...
struct VKVerificationInfo: Decodable {
    ...
    enum CodingKeys: String, CodingKey { case verifications }
}
